...
public class Itext5HtmlToPDF {
    ...
    public void createPdf() {
        try {
            ...
            PdfWriter mPdfWriter = PdfWriter.getInstance(document, new FileOutputStream("E:\\liuce\\test3.pdf"));
            document.open();
...
//            将图片合成pdf
            Image image = Image.getInstance("https://csdnimg.cn/medal/qixiebiaobing4@240.png");
    ...
    public static String getHtml() {
        ...
        html.append("</table>");
        html.append("测试字段");
        html.append("<div>测试字段加标签</div>");
        html.append("<div><p>测试字段加p标签</p></div>");
        html.append("<img src ='https://csdnimg.cn/medal/qixiebiaobing4@240.png'/>");
